...
## Model Selection
We see that the random forest model performs best, with an estimated out-of-sample accuracy of `r round(100*max(fitRF$results$Accuracy),digits=2)`% and out-of-sample error of `r round(100*(1 - max(fitRF$results$Accuracy)),digits=2)`%. Therefore, we select this model to use on the training dataset.
